...
describe('resetTask', () => {
  ...
  beforeEach(async done => {
    ...
    mock
      .onPost(`/collection/${collectionId}/bullet/${bulletId}/reset`)
      .reply(200, mockResponse);

    actions = await getAsyncActions(resetTask, [collectionId, bulletId]);
    done();
  });

  it('successfully marks a task as reset', () => {
    const expectedActions = [
      { type: types.RESET_TASK_REQUEST, bulletId },
      {
